...
var RULES = {
  ...
  sections: [
    { h: "1. Punctuality and attendance", items: [
      ...
      "You may use protected time off (safe and sick leave) as provided by New York State and New York City law: for your own illness, injury or medical care, to care for a family member, for \"safe time\" needs (for example domestic violence), and for the paid prenatal care leave New York law provides. Let us know as soon as you reasonably can — email all the contacts listed at the end, or text or call the work phone number — as explained in section 3 of the Protected Time Off policy; if the appointment is planned, tell us in advance. We will never ask you what your illness is, ask you to find your own replacement, or ask you to make up the hours, and using this leave is never counted as an attendance problem. The details (how much leave you earn, when it is paid, and your balance) are in Bar Lento's Protected Time Off (Safe and Sick Leave) Policy and in the NYC Notice of Employee Rights: Protected Time Off, both under Documents in the app (the Notice is also available in Italian) — ask an owner or the manager if you have not received them.",
    ...
    { h: "2. Respect and teamwork", items: [
      ...
      "Bar Lento's Sexual Harassment Prevention Policy (New York Labor Law §201-g) applies to everyone. You receive the policy and its complaint form under Documents in the app and on paper — ask an owner or the manager if you have not received them, or if you would like them explained in Italian — and you complete the required anti-harassment training every year on paid time.",
    ...
    { h: "11. Payments, cash and tips", items: [
      ...
      "Tips belong to the team members who earn them and are protected by New York Labor Law §196-d: owners and the manager never take any share of tips. Card tips are recorded in Toast and paid to you with your regular pay. Bar Lento does not operate a tip pool or mandatory tip sharing: every tip a guest leaves for you is yours. The details are in the Tips Policy under Documents in the app.",
      "If a guest leaves a cash tip, it is yours: keep it and declare it in Toast when you clock out (Declare Cash Tips), as the Tips Policy explains — cash tips must be reported for tax purposes. Never keep undeclared cash."
    ]},
    ...
    { h: "15. Health, allergies and accommodations", items: [
      ...
      "If you are breastfeeding, New York law gives you paid 30-minute breaks to express milk each time you need them, for up to three years after birth, and a private, clean space that is not a bathroom. Bar Lento's written lactation policy is given to you when you are hired and again every January — ask an owner or the manager if you have not received it."
    ]},
    ...
    { h: "17. How to communicate with us", items: [
      "For anything work-related — absences, lateness, questions, problems, urgent matters and anything you want on record — send one email to all the contacts listed at the end. When the matter is urgent, also speak to the owner or manager on duty. (For protected time off, section 3 of the Protected Time Off policy applies.)",
