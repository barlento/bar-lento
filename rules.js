...
window.BL_RULES = {
  ...
  sections: [
    ...
    { h: "5. Alcohol, cannabis and drugs", items: [
    ...
    { h: "6. Restrooms, changing area and lockers", items: [
    ...
    { h: "7. Security: doors and keys", items: [
    ...
    { h: "9. Video surveillance and electronic monitoring notice", items: [
    ...
    { h: "10. Staff meal and breaks", items: [
    ...
    { h: "11. Health, allergies and accommodations", items: [
    ...
    { h: "12. How to communicate with us", items: [
