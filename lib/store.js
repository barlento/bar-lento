...
function normalizeData(raw) {
  ...
  if (raw.dept && typeof raw.dept === "object") Object.keys(raw.dept).forEach((n) => { const v = raw.dept[n]; if (v === "kitchen" || v === "floor" || v === "management") data.dept[String(n).trim().slice(0, 60)] = v; }); // floor, kitchen or management; unset = floor
