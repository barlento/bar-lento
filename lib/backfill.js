// Past weeks = what actually happened (owner's rule 2026-09-19, "niente storico a caso"). A past week contains ONLY
...
// barlento:plan_archive, never lost). Only past weeks (before this Monday) inside the range are rewritten; this week
// and the future are always scheduled by hand. Idempotent: run it any time.
...
const AUTO_KEY = "barlento:backfill_at:v2"; // bump when the rule changes so the next visit rewrites the past weeks
