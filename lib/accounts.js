...
module.exports = { getRulesAck, setRulesAck, allRulesAck, hasPin, createPin, login, whoIs, logout, logoutEverywhere, resetPin, removeAccounts, summary, lockInfo, getPinRecord, validPin, validToken };
