...
module.exports = { getRulesAck, setRulesAck, allRulesAck, allRulesAckArchive, getDocAck, setDocAck, allDocAck, allDocAckArchive, docAcksFor, hasPin, createPin, login, whoIs, logout, logoutEverywhere, resetPin, removeAccounts, summary, lockInfo, getPinRecord, validPin, validToken };
