...
- Manager login (password) is only a service door for a shared device; managers normally sign in with their own name and PIN and get their tools automatically.
...
- Your strip: "Hi <name> · next shift …" with two buttons: My week and My stats (people who clock in from the app see Clock in / Clock out instead of My stats).
...
## Clock-ins (hours)
Hours worked come from clock-ins. Most people clock in and out on the Toast POS terminal with their own Toast account, never in the app. A few people who are not on Toast or are salaried clock in from the app (Clock in / Clock out button in their strip → confirm). The app never lets anyone edit or create a time entry. If a clock-in looks wrong, tell the manager.
