...
- Reports: the owner (button in his strip, instead of My stats) and the manager (Reports in the bar) pick Everyone or one person and a period (today, this week, last week, this month, last month, custom dates) and download the PDF. Everyone = team hours from clock-ins; one person = the personnel record for that period. The chef has no reports. Every person has "My report" in My week: their own hours as a PDF for today, this week, this month, last month or custom dates. The owner has no personal stats or report: he does not work shifts.
- When the manager has finished posting a week (10 quiet minutes after her last change), everyone gets a push; the next time you open the app a popup lists YOUR shifts of that week with one button "Confirm my shifts" (or Later). It appears once per person per posted week.
- A bell at the top right with a red number appears only while you have something to complete: add your birthday, read and sign documents, confirm your shifts. Tap it, then "Do it" on a row: it takes you straight there. When everything is done the bell disappears.
