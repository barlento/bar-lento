...
- Only the owner has "Reports" (in his strip, instead of My stats; managers and the chef have no reports or PDF downloads): pick Everyone or one person, a period (this week, last week, this month, last month, custom dates), Download PDF. Everyone = team hours from clock-ins; one person = the personnel record for that period. The owner has no personal stats or week report: he does not work shifts.
