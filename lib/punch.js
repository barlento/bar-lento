...
function isAppClock(data, name) { return Array.isArray(data.appClock) && data.appClock.includes(name); }
...
module.exports = { isAppClock, all, openEntry, punch, between, weekEntries, month, minutes, archive };
