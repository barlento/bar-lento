...
// breast milk in the workplace (2024 revision). Generated by scratchpad/gen/build.py — edit the text here directly if needed.
...
var DOCS = {
  ...
  "list": [
    ...
    },
    {
      ...
      "intro": "New York State requires every employee to complete interactive sexual harassment prevention training every year, and new employees as soon as possible after they start. Bar Lento uses the State’s official training video, in English or in Italian. Watching it is paid working time: watch it during a shift when the floor is quiet, or tell the Manager the time you spent so it is added to your paid hours.",
      "sections": [
        {
          "h": "How to complete it",
          "blocks": [
            [
              "Watch the New York State model training video, in English or in Italian (links below). It lasts about 20 minutes. Watch it to the end.",
              "Optional: the State also publishes short case-study videos you can watch afterwards.",
    ...
    },
    {
      ...
      "sections": [
        ...
        },
        {
          ...
          "blocks": [
            [
              "Planned absence (you know 7 or more days ahead: a doctor’s appointment, a court date, a school closure announced in advance): tell us as early as you can, and at most 7 days before, by email to all the contacts at the end of this policy, or by text to the work phone number posted in the staff area. Say how many hours or which shifts you need. Bar Lento cannot ask for more than 7 days’ notice.",
        ...
        },
        {
          ...
          "blocks": [
            [
              "Bar Lento asks for documentation only if you use protected time off for more than 3 consecutive workdays. For 3 days or fewer, no documentation is ever asked.",
        ...
        },
        {
          ...
          "blocks": [
            [
              ...
              "You can use protected time off for a whole shift or part of a shift, in steps of 15 minutes: there is no minimum increment. The same applies to paid prenatal leave.",
      ...
      "links": [
        ...
        {
          "label": "Avviso dei diritti dei dipendenti — Italiano (PDF ufficiale)",
    ...
    },
    {
      ...
      "sections": [
        ...
        },
        {
          "h": "3. Cash tips",
          "blocks": [
            "Cash tips are kept by the employee who received them. Bar Lento is cashless for payments, but a guest may still leave cash as a tip: it is yours. Declare your cash tips in Toast when you clock out (Declare Cash Tips): federal law requires you to report cash tips to your employer, and accurate reporting protects your Social Security, disability and unemployment benefits."
          ]
        },
        {
        ...
        },
        {
          "h": "8. Guests and tips",
          "blocks": [
            "Never ask a guest for a tip, comment on the size of a tip, or treat a guest differently because of a tip. A guest who pressures you for anything in exchange for a tip is harassing you: tell the Manager or Owner on duty at once (see the Sexual Harassment Prevention Policy)."
          ]
        },
        {
      ...
      "links": [
        {
          "label": "New York State Department of Labor — tips and gratuities",
          "url": "https://dol.ny.gov/tips-and-gratuities-frequently-asked-questions"
        }
      ],
      ...
      "links": [
        {
          ...
          "url": "https://dol.ny.gov/breast-milk-expression-workplace"
        },
        {
